...
class AdminController extends Controller
{
    ...
    public function AdminProfileStore(Request $request) {
        // Validasi input (nullable karena tidak selalu harus diubah semua)
        $request->validate([
        ...
        // Variabel untuk melacak apakah ada perubahan data
        $hasChanges = false;
    
        // Update hanya jika ada perubahan
        if (isset($request->name) && $request->name !== $data->name) {
            $data->name = $request->name;
            $hasChanges = true;
        }
        ...
        if (isset($request->phone) && $request->phone !== $data->phone) {
            $data->phone = $request->phone;
            $hasChanges = true;
        }
        ...
        if ($request->hasFile('photo')) {
            ...
            $file->move(public_path('upload/admin_images'), $filename);
            $data->photo = $filename;
            $hasChanges = true; // Foto baru berarti ada perubahan
        ...
        // Jika ada perubahan, simpan data dan kirim notifikasi sukses
        if ($hasChanges) {
            $data->save();
            $notification = array(
                'message' => 'Profile Update Successfully',
