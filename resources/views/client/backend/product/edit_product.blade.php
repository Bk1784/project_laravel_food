        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input class="form-control" name="discount_prize" type="text"   id="example-text-input" value="{{ $product->discount_prize}}">
                    </div>
            </div>
            ...
            <div class="col-xl-6 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input class="form-control" name="qty" type="text"  id="example-text-input" value="{{ $product->most_populer}}">
                    </div>
            </div>
            <div class="col-xl-6 col-md-6">
                    <div class="form-group mb-3">
