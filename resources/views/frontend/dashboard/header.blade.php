...
<html lang="en">
   <head>
      ...
      <!-- Favicon Icon -->
      <link rel="{{ asset('frontend/icon') }}" type="image/png" href="img/favicon.png">
      <!-- Bootstrap core CSS-->
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
               <ul class="navbar-nav ml-auto">
                  ...
                  <li class="nav-item dropdown">
                     ...
                     <img alt="Generic placeholder image" src="{{ (!empty($profileData->photo)) ? url('upload/user_images/'.$profileData->photo) : url('upload/poto_filmBagus.jpg') }}" class="nav-osahan-pic rounded-pill"> My Account
                     </a>
