        ...
        <div class="item">
            <div class="mall-category-item">
                <a href="#">
                    ...
                    <h6>{{ $populer->name }}</h6>
                    @if ($populer->discount_prize == NULL)
                        ${{$populer->price}}
                    @else
                    $<del>{{$populer->price}}</del> ${{$populer->discount_prize}}
                    @endif
                               ...
                               <div class="p-3 position-relative">
                                  ...
                                  <h6 class="mb-1"><a href="#" class="text-black">{{$bestseller->name}}</a></h6>
                                    ...
                                    <p class="text-gray time mb-0">
                                       @if ($bestseller->discount_prize == NULL)
   ...
   @endphp   
      ...
      <a class="text-center w-100 d-block mt-4 font-weight-bold" href="#">See All Reviews</a>
                      ...
                      <div class="bg-white rounded shadow-sm p-4 mb-5 rating-review-select-page">
                         @guest
                         <p><b>For Add Restaurant Review. You need login First <a href="{{ route('login') }}">Login Here</a></b></p>
                         @else
                         <style>
                     .star-rating label {
                        display: inline-flex;
             ...
             <div class="generator-bg rounded shadow-sm mb-4 p-4 osahan-cart-item">
               ...
               @if (session('cart'))
                ...
                <div class="gold-members p-2 border-bottom">
                      <p class="text-gray mb-0 float-right ml-2">Rp. {{ $details['price'] * $details['quantity'] }}</p>
